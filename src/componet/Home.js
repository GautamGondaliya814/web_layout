...
const Home = () => {
     return (
          <>
               <div className="main_banner spacer">
                    <Container>
                         <Row>
                              <Col lg={6} xs={12} className="d-flex my-auto">
                              ...
                              <Col lg={6} xs={12}>
                                   <div className="hero_banner">
                                        <div className="banner_img">
                                             <img src={require('../img/asset 12.jpeg')} alt="" width="100%" />
                                        </div>
                                        <div className="shape3">
                                             <img src={require('../img/shape3.png')} alt="" width="100%" />
                                        </div>
                                        <div className="shape4">
                                             <img src={require('../img/shape4.png')} alt="" width="100%" />
                                        </div>
                                        <div className="shape5">
                                             <img src={require('../img/shape5.png')} alt="" width="100%" />
                                        </div>
                                        <div className="shape6">
                                             <img src={require('../img/shape6.png')} alt="" width="100%" />
                                        </div>
                                   </div>
                              </Col>
                         </Row>
               ...
               <Course />
               <Categories />
               <div className="video_one pt-0 pb-3">
                    <Container>
                         <div className="video_bg">
                         <Row>
                              <Col lg={6} md={7}className="z-1">
                                   <div className="video_content">
                                   <div className="video_title">
                                        <h3>Discover the Campus Through a Video Tour</h3>
                                   </div>
                                   <div className="banner_btn">
                                        <div className="btn">
                                             <a href="#index">
                              ...
                              <Col lg={6} md={5}className="z-1">
                                   <div className="video_one_btn">
                                        <img src={require('../img/video2.png')} alt="" />
                                        <a href="#index" className="popup"><BsFillPlayFill></BsFillPlayFill></a>
                                   </div>
                              </Col>
                         </Row>
                         <div className="shape">
                              <div className="shape13">
                                   <img src={require('../img/shape13.png')} alt="" />
                              </div>
                         </div>
                         </div>
                    </Container>
